...
ActiveRecord::Schema.define(version: 2018_04_23_043853) do
  ...
  create_table "collaborative_recommendations", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    t.string "user_id"
  ...
  create_table "text_recommendations", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    t.string "user_id"
    t.string "business_id"
    t.float "value"
    t.integer "category"
